...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.refFranchisee'
        db.alter_column('users_userprofile', 'refFranchisee_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.UserProfile'], null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.refFranchisee'
        db.alter_column('users_userprofile', 'refFranchisee_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.UserProfile']))
