...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CreateCodes.dateCreateCode'
        db.add_column('users_createcodes', 'dateCreateCode',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 20, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'UserProfile.lastAccess'
        db.alter_column('users_userprofile', 'lastAccess', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Deleting field 'CreateCodes.dateCreateCode'
        db.delete_column('users_createcodes', 'dateCreateCode')


        # Changing field 'UserProfile.lastAccess'
        db.alter_column('users_userprofile', 'lastAccess', self.gf('django.db.models.fields.DateTimeField')())
