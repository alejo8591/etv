...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.alternativePhone'
        db.alter_column('users_userprofile', 'alternativePhone', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

        # Changing field 'UserProfile.phone'
        db.alter_column('users_userprofile', 'phone', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.alternativePhone'
        db.alter_column('users_userprofile', 'alternativePhone', self.gf('django.db.models.fields.CharField')(default=None, max_length=60))

        # Changing field 'UserProfile.phone'
        db.alter_column('users_userprofile', 'phone', self.gf('django.db.models.fields.CharField')(default=None, max_length=60))
