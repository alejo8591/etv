...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.keyExpires'
        db.alter_column('users_userprofile', 'keyExpires', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'UserProfile.activationKey'
        db.alter_column('users_userprofile', 'activationKey', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.keyExpires'
        db.alter_column('users_userprofile', 'keyExpires', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'UserProfile.activationKey'
        db.alter_column('users_userprofile', 'activationKey', self.gf('django.db.models.fields.CharField')(default=None, max_length=60))
